...
export const defaultLandingPage: LandingPage = {
  ...
  welcome: {
    ...
    images: ['/images/gallery-landscape-1.jpg', '/images/gallery-guest-1.jpg'],
  },
  experiences: {
  ...
  gallery: {
    ...
    images: ['/images/gallery-dining.jpg', '/images/gallery-guest-1.jpg', '/images/gallery-guest-2.jpg', '/images/gallery-yoga.jpg', '/images/gallery-landscape-1.jpg'],
  },
  contact: {
