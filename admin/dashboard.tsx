...
const emptyLanding: LandingConfig = {
  ...
  footer: { showCta: true, bottomText: "Booking request website", quickLinksTitle: "Quick links", contactTitle: "Contact Us", socialTitle: "Follow Us" },
